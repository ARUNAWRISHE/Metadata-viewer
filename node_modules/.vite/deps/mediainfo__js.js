...
var MediaInfo = class {
  ...
  openBufferContinue(data, size) {
    return !!(this.mediainfoModuleInstance.open_buffer_continue(data, size) & 8);
  }
  /**
...
`;
  ...
  function craftInvokerFunction(humanName, argTypes, classType, cppInvokerFunc, cppTargetFunc, isAsync) {
    ...
    var closureArgs = [
      ...
      instType == null ? void 0 : instType.toWireType.bind(instType)
    ];
  ...
  function assignWasmExports(wasmExports2) {
    ___getTypeName = wasmExports2["__getTypeName"];
    _malloc = wasmExports2["malloc"];
    _free = wasmExports2["free"];
...
export {
  mediaInfoFactory as default,
  isTrackType,
  mediaInfoFactory
};
//# sourceMappingURL=mediainfo__js.js.map
